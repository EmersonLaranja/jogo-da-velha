class JogoDaVelha:
    ...
    #define os parâmetros iniciais da classe, sempre executado quando instanciado
...
#instanciação da classe na variavel jogo (jogador opcional)
jogo = JogoDaVelha()
